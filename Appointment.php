          ...
          <?php
            while($row=mysqli_fetch_array($result))
            {
              ...
              <tr>
               ...
               <td><a href="Edit3.php?Appointment_id=<?php echo $row['Appointment_id']?>" class="btn btn-info btn-sm">Edit</a>
               <a href="Delete3.php?Appointment_id=<?php echo $row['Appointment_id']?>" class="btn btn-danger btn-sm">Delete</a>
               </td>
              </tr>
              <?php
            }
