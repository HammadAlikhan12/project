        ...
        while($row=mysqli_fetch_array($result))
{
  ?>
           <tr>
               ...
               <td><a href="Edit.php?Client_name=<?php echo $row['Client_name']?>" class="btn btn-info btn-sm">Edit</a>
               <a href="Delete.php?Client_name=<?php echo $row['Client_name']?>" class="btn btn-danger btn-sm">Delete</a>
              </td>
            </tr>
            <?php
}
