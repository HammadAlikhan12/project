...
<html lang="en">
    ...
    <section class="pb_section pb_section_v1" data-section="about" id="section-about">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="images">
              <img class="img1 img-fluid" src="../law-master/assets/images/600x450_img_2.jpg" alt="free Template">
              <img class="img2" src="../law-master/assets/images/800x500_img_1.jpg" alt="free Template">
            </div>
          </div>
    ...
    <section class="pb_sm_py_cover text-center cover-bg-black cover-bg-opacity-4" style="background-image: url(../law-master/assets/images/1900x1200_img_3.jpg)">
      <div class="container">
      ...
      <div class="multiple-items pb_slide_v1">
        <div>
          <a href="#" class="link-block">
            <img src="../law-master/assets/images/1900x1200_img_4.jpg" alt="" class="img-fluid">
        ...
        <div>
          <a href="#" class="link-block">
            <img src="../law-master/assets/images/1900x1200_img_2.jpg" alt="" class="img-fluid">
            <div class="slide-text">
              <h2>Migration Law</h2>
              <span>Read More</span>
            </div>
        ...
        <div>
          <a href="#" class="link-block">
            <img src="../law-master/assets/images/1900x1200_img_3.jpg" alt="" class="img-fluid">
            <div class="slide-text">
              <h2>Civil Rights</h2>
              <span>Read More</span>
            </div>
        ...
        <div>
          <a href="#" class="link-block">
            <img src="../law-master/assets/images/1900x1200_img_1.jpg" alt="" class="img-fluid">
            <div class="slide-text">
              <h2>Civil Rights</h2>
              <span>Read More</span>
            </div>
